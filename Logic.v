...
Theorem proj2 : forall P Q : Prop, 
  P /\ Q -> Q.
Proof.
  (* 1 star and not required *) Admitted.
(** [] *)
...
Theorem iff_refl : forall P : Prop, 
  P <-> P.
Proof. 
  (*one star and optional *) Admitted.
...
Theorem or_distributes_over_and_2 : forall P Q R : Prop,
  (P \/ Q) /\ (P \/ R) -> P \/ (Q /\ R).
Proof.
  intros P Q R H. inversion H as [[HP | HQ] [HP2 | HR]].
  left. apply HP. left. apply HP. left. apply HP2. 
  right. split.
  Case "left".
    apply HQ.
  Case "right".
...
(**do this optional exercise**)
(** **** Exercise: 2 stars, optional (bool_propt) *)
Theorem andb_false : forall b c,
  andb b c = false -> b = false \/ c = false.
Proof. 
  intros b c H. unfold andb in H.  destruct b. right.
  Case "right". apply H.
  left.
  Case "left". reflexivity.
Qed. (*
  destruct rewrite->H. destruct c.
  destruct b. reflexivity. reflexivity. destruct b. reflexivity.


reflexivity. inversion H.  destruct (andb b c). destruct b.
  left. reflexivity.
  destruct c. right. reflexivity.
  rewrite->H.
  left. reflexivity. destruct b. destruct c.
  left. 
  Admitted.*)
...
Proof. 
  intros b c. unfold orb. destruct b.
  Case "b = true".
    intros H.
    rewrite->H.
    split.
    ...
    SCase "right".
      destruct c.
      rewrite->H.
      repeat reflexivity. reflexivity.
  Case "b = false".
    intros H.
    split.
    SCase "left".
...
Theorem contrapositive : forall P Q : Prop,
  (P -> Q) -> (~Q -> ~P).
Proof.
  intros P Q H. unfold not. intros H2 H3.
...
Theorem not_both_true_and_false : forall P : Prop,
  ~ (P /\ ~P).
Proof. 
  (* one star, not required *) Admitted.
(** [] *)
...
Proof.
  intros P. unfold not. intros H. apply H. right. intros H2.
  apply H. left. apply H2.
Qed.
(*
apply or_introl in H.  intros H1.

destruct P.  apply H. right. 
 SearchAbout not.
  Admitted.*)
(*

 unfold not. intros H. SearchAbout False.
   unfold False. left in H.
...
reflexivity. inversion H. reflexivity. 
  apply H.  rewrite->H. left. destruct P.*)
...
Theorem false_beq_nat : forall n m : nat,
     ...
     beq_nat n m = false.
Proof. 
  intros n m. intros H. SearchAbout beq_nat.
  unfold not in H. generalize dependent m.
  induction n as [|n'].
  Case "n = O".
    intros m.
    intros H2.
