...
Inductive substi (s:tm) (x:id) : tm -> tm -> Prop := 
  ...
  | s_abs1 : forall (w : ty) (t : tm),
    substi s x (tabs x w t) (tabs x w t)
  | s_abs' : forall (x' : id) (w : ty) (t : tm) (t' : tm),
    x <> x' -> substi s x t t' -> substi s x (tabs x' w t) (tabs x' w t')
  | s_app : forall (t : tm) (t2 : tm) (t' : tm) (t2' : tm),
    substi s x t t' ->
    substi s x t2 t2' ->
    substi s x (tapp t t2) (tapp t' t2')
  | s_true : 
    substi s x ttrue ttrue
  | s_false : 
    substi s x tfalse tfalse
  | s_if : forall (t : tm) (t' : tm) (t2 : tm) (t2' : tm) (t3 : tm) (t3' : tm),
    substi s x t t' -> substi s x t2 t2' -> substi s x t3 t3' ->
    substi s x (tif t t2 t3) (tif t' t2' t3').
