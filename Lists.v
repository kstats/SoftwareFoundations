...
Proof.
  (* ONe star and optional, not required*) Admitted.
(** [] *)
...
Fixpoint alternate (l1 l2 : natlist) : natlist :=
  (* advanced exercises not required *) admit.
...
(*********KATIE YOU HAVE TO DO THIS BAG MORE FUNCTIONS******************)
...
Theorem interesting_theorem2 : forall (s:bag)(n:nat),
  1 + count n s =count n (add n s).
Proof. intros s n. simpl. 
...
Lemma rev_involutive_lemma : forall (n:nat) (l:natlist),
...
Proof.
  intros l. induction l as [|n l'].
    Case "l = nil".
      reflexivity.
    Case "l = cons". 
      simpl. rewrite->rev_involutive_lemma. 
...
Proof.
  ...
  Case "l1 = cons".
    simpl. rewrite-> IHl1. repeat rewrite->snoc_append.
    rewrite->app_assoc.
    reflexivity.
Qed.
...
Theorem non_trivial : forall (t t2 : natlist) (h : nat),
   snoc t h ++ t2=  t ++ h :: t2.
Proof.
  intros t t2 h.
  induction t as [|t'].
...
Proof.
  (* advanced not required *) Admitted.
...
Proof.
  (* 1 star/optional not required *) Admitted.
(** [] *)
...
Fixpoint beq_natlist (l1 l2 : natlist) : bool :=
  ...
  |h :: t => match l2 with
             |nil => false (**bc l1 still has elements but l2 doesn't**)
...
(**note above, same beq_nat_refl was used.**) 
(** [] *)
